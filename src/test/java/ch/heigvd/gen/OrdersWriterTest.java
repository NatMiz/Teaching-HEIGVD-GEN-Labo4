...
import ch.heigvd.gen.Color.BlueColor;
import ch.heigvd.gen.Color.RedColor;
...
public class OrdersWriterTest {
    ...
    public void OneOrderWithOneProduct() {
        order111.AddProduct(new Product("Shirt", new BlueColor(), Size.M, 2.99, "TWD"));
    ...
    public void OneOrderWithOneProductNoSize() {
        order111.AddProduct(new Product("Pot", new RedColor(), Size.SIZE_NOT_APPLICABLE, 16.50, "SGD"));
